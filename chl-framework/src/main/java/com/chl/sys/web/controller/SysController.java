...
public class SysController {
     ...
     * @return
     */
    @RequestMapping("toDictTypeManager")
    public String toDictTypeManager() {
        return "sys/dictType/dictTypeManager";
    }
     ...
     * @return
     */
    @RequestMapping("toDictItemManager")
    public String toDictItemManager() {
        return "sys/dictItem/dictItemManager";
    }
